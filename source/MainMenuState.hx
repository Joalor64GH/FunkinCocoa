...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		magenta.antialiasing = !FunkySettings.noAntialiasing;
		...
		for (i in 0...optionShit.length)
		{
			...
			menuItem.antialiasing = !FunkySettings.noAntialiasing;
		...
		{ // It's a friday night. WEEEEEEEEEEEEEEEEEE
			...
			giveAchievement();
			Achievements.unlockAchievement('friday_night_play', stat);
			FunkySettings.save();
		}
		#end
