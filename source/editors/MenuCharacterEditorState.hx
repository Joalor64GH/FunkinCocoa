...
class MenuCharacterEditorState extends MusicBeatState
{
	...
	// 1 = idle offset, 2 = confirm offset
	...
	override function create()
	{
		...
		var tipText:FlxText = new FlxText(0, 540, FlxG.width, "Arrow Keys - Change Current Offset (Hold shift for 10x speed)
	...
	function reloadSelectedCharacter()
	{
		...
		if (characterFile.confirm_anim != null
			...
			&& characterFile.confirm_anim != characterFile.idle_anim)
	...
	function updateConfirmOffset()
	{
		...
		char.playAnim();
		// txtOffsets.text = 'Confirm Animation Offsets: ${beautifyOffset(characterFile.confirmPosition)}';
	}
